    ...
    <div id="contactme" className="mt-12">
      ...
      <div className="flex justify-center mt-16">
        <form
          ref={form}
          onSubmit={sendEmail}
          className="flex flex-col bg-gray-500 border-2 border-gray-300 rounded-2xl p-8 gap-6 shadow-lg max-w-md w-max"
        >
          <section className="flex flex-col">
            ...
            <input
              ...
              className="border-2 border-gray-300 bg-gray-200 p-3 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-blue-400"
              type="text"
              name="from_name"
              required
